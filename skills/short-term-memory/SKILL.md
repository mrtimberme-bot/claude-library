...
- Recent momentum, nuanced decisions, next logical step, mental state, decision timestamps
...
Keep: the WHAT, WHERE, HOW — function names, file names, moves.
...
✅ User never says "I already told you that"
✅ User never says "check the context"
✅ You know "what's next" without asking
✅ Smooth continuation after compaction

❌ Entries are paragraphs
❌ Missing timestamps
❌ Asking questions already in current-context.md
